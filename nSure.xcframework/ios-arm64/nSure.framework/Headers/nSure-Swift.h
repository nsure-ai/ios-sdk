...
/// \param apiKey Fingerprint public API key.
///
...
/// When non-nil, called instead of FingerprintFactory in performFetch.
/// Use in pre-commit / CODE_SIGNING_ALLOWED=NO environments where
/// Fingerprint’s Keychain init crashes (missing entitlements).
